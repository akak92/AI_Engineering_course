"""
Capa de Recuperación (Retriever) del sistema RAG.

Se conecta a la misma colección de ChromaDB poblada por `ingest.py`,
reutilizando exactamente el mismo `COLLECTION_NAME` y `EMBEDDING_MODEL`
(mismo `PersistentClient` + misma `OpenAIEmbeddingFunction`), para
...
class SemanticRetriever:
    ...
    def __init__(
        self,
        persist_path: str = str(PERSIST_DIR),
    ...
    def retrieve(self, query: str, top_k: int = 2) -> list[RetrievedFragment]:
        """
